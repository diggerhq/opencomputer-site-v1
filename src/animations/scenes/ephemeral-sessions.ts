...
export const ephemeralSessionsScene = defineScene({
  meta: {
    ...
    durationMs: 7600,
    viewport: { width: 1100, height: 550, padding: 40 },
  },
  nodes: [
    { id: "user-source", kind: "source", x: 200, y: 160, width: 244, height: 96, label: "User Input", subtitle: "Prompt or task", icon: "user" },
    { id: "api-source", kind: "source", x: 200, y: 380, width: 244, height: 96, label: "System Events", subtitle: "Automated triggers", icon: "webhook" },
    { id: "control-plane", kind: "service", x: 525, y: 270, width: 232, height: 112, label: "Control Plane", subtitle: "Routes work", icon: "controlPlane" },
    { id: "sandbox-a", kind: "sandbox", x: 855, y: 160, width: 232, height: 112, label: "Sandbox A", icon: "agent" },
    { id: "sandbox-b", kind: "sandbox", x: 855, y: 380, width: 232, height: 112, label: "Sandbox B", icon: "agent" },
    { id: "control-plane-core", kind: "service", x: 525, y: 270, width: 2, height: 2, label: "Control Plane Core", hidden: true },
    { id: "sandbox-a-core", kind: "sandbox", x: 855, y: 160, width: 2, height: 2, label: "Sandbox A Core", hidden: true },
    { id: "sandbox-b-core", kind: "sandbox", x: 855, y: 380, width: 2, height: 2, label: "Sandbox B Core", hidden: true },
  ],
  edges: [
